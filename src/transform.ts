import type { GLeaguePlayerSeasonRecord, HoopCentralIngestPayload } from "./types.js";
import { nameToSlug } from "./utils/teams.js";

export function toIngestPayload(
  record: GLeaguePlayerSeasonRecord,
...
export function buildPlayerSeasonRecord(input: {
  ...
  seasonLabel: string;
  stats: GLeaguePlayerSeasonRecord["stats"];
}): GLeaguePlayerSeasonRecord {
  return {
